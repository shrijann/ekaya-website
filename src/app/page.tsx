...
export default function Home() {
  ...
  const handleBookingSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    setBookingStatus('Thank you! Your booking request has been drafted. Redirecting to mail...');
    setTimeout(() => {
      window.location.href = `mailto:donoborie@gmail.com?subject=Ekaya Hami Performance Booking Request`;
    }, 1200);
  };
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-neutral-100 font-sans selection:bg-amber-500 selection:text-black">
      ...
      <section id="members" className="py-20 px-6 max-w-7xl mx-auto border-b border-neutral-900/60">
        ...
        <div className="mt-20">
          <div className="text-center mb-10">
            <span className="text-amber-500 text-xs font-bold uppercase tracking-widest">Production & Support</span>
      ...
      <section id="booking" className="py-20 px-6 max-w-4xl mx-auto">
        <div className="bg-[#121212] border border-neutral-800 rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden shadow-2xl">
          <span className="text-amber-500 text-xs font-bold uppercase tracking-widest">Live Events & Shows</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mt-2 mb-4">Book Ekaya Hami</h2>
          ...
          <button
            onClick={() => setIsBookingOpen(true)}
            className="bg-amber-500 hover:bg-amber-400 text-black font-bold px-8 py-4 rounded-full transition-all transform hover:scale-105 shadow-xl shadow-amber-500/20"
          >
      ...
      {isBookingOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
          <div className="bg-[#141414] border border-neutral-800 w-full max-w-lg rounded-3xl p-6 sm:p-8 relative shadow-2xl">
            ...
            <p className="text-xs text-neutral-400 mb-6">Fill out event details to book Ekaya Hami for your event.</p>
      ...
      <footer className="py-12 border-t border-neutral-900 text-center text-xs text-neutral-500 space-y-2">
        <p className="text-sm text-neutral-300 font-medium">For Bookings & Press: Contact via Instagram @ekayahami</p>
